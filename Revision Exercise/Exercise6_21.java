/**
 * Exercise 6.21 is a program that simulates a game machine game that lets the
 * user decide number of balls and number of slots and then shows the path each ball
 * has gone.
 *
...
public class Exercise6_21 {
	...
	/** getRandomPath returns string L or R randomly */
